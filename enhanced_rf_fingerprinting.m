    ...
    for localFramesPerRouter = FramesPerRouter
        for k = kValues
            ...
            layers = [
                ...
                % ResNet Block 1 (with skip connection)
                additionLayer(2, 'Name', 'Add1')
                
                % CNN Feature Extraction Block 3
                convolution2dLayer([3 1], 64, 'Padding', [1 0], 'Name', 'Conv3')
                ...
                % Self-Attention mechanism (implemented as fully connected layers)
                fullyConnectedLayer(128, 'Name', 'Attention_Query')
                fullyConnectedLayer(128, 'Name', 'Attention_Key')  
            ...
            % Add skip connection for ResNet block
            % Connect Conv2 output to Add1 input (skip connection)
            lgraph = connectLayers(lgraph, 'ReLU2', 'Add1/in2');
            lgraph = connectLayers(lgraph, 'ReLU3', 'Add1/in1');
            ...
            tic
            fprintf('Training enhanced hybrid model...\n');
            ...
            disp(['Enhanced model average accuracy: ', num2str(averageAccuracy*100), '% ± ', num2str(stdAccuracy*100), '%']);
            ...
            fprintf('Enhanced model results saved to %s\n\n', saveFileName);
        end
    end
end
